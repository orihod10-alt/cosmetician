...
export default function WhatsAppFAB() {
  ...
  return (
    <div className={`wa-fab-wrapper${visible ? " is-visible" : ""}`} aria-label="הזמיני דרך וואטסאפ">
      <div className="wa-fab-pulse" aria-hidden />
      <a
        href={WA_LINK}
        target="_blank"
        rel="noopener noreferrer"
        className="wa-fab-button"
        aria-label="פתחי שיחת וואטסאפ להזמנת תור"
      >
        <svg
          viewBox="0 0 24 24"
          width="22"
